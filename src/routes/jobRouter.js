...
import { createJob, getMyJobs, getAllJobs, searchJobs, likedSavedJob, getMySavedLikedJobs  , deletJob , applyJob } from "../controllers/jobController.js";
...
jobRouter.post('/api/apply-job', [authMiddleware], applyJob)